<template>
    <section>
        <p class="text-xl text-lime font-regular">Hello, my name is</p>
        <h1 class="text-6xl text-offwhite font-semibold pb-1">Lucas Guiss Gusmão</h1>
        <h2 class="text-4xl text-offwhite font-medium pb-1">Tech Leader and Software Engineer </h2>
        <p class="text-xl text-grey break-words font-regular">I design and build scalable and resilient applications for the
            web.
        </p>
